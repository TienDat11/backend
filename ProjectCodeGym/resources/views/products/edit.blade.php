    ...
    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="mb-3 mb-3 col-xs-12 col-md-12 col-sm-12">
                ...
                <input class="form-control"  id="image" name="image" placeholder="image..."  type="file" accept="image/*" onchange="loadFile(event)">
                <img src="/image/{{ $product->image }}" width="300px" id="output" />
                @error('image')
                    <span style="color: red">{{ $message }}</span>
                @enderror
            </div>
